...
filu_pas= uicontrol('Style','listbox','String',flu_pas,'ListboxTop',2,...
 ...
 uic(2)=uicontrol('Style','Checkbox','Position',[20 340 20 20],...
       ...
       uicontrol('Style','text','String','Просмотреть файл',...
          'Position',[40 340 260 20]);
...
if gg~=0
   % если была нажата кнопка 'O.K.' выполняется обработка (функция obr[xx])
